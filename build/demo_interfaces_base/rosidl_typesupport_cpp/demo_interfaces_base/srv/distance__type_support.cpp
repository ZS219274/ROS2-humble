...
static const _Distance_Request_type_support_symbol_names_t _Distance_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, demo_interfaces_base, srv, Distance_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, demo_interfaces_base, srv, Distance_Request)),
  }
};
...
get_message_type_support_handle<demo_interfaces_base::srv::Distance_Request>()
{
  return &::demo_interfaces_base::srv::rosidl_typesupport_cpp::Distance_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, demo_interfaces_base, srv, Distance_Request)() {
  return get_message_type_support_handle<demo_interfaces_base::srv::Distance_Request>();
}
...
static const _Distance_Response_type_support_symbol_names_t _Distance_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, demo_interfaces_base, srv, Distance_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, demo_interfaces_base, srv, Distance_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<demo_interfaces_base::srv::Distance_Response>()
{
  return &::demo_interfaces_base::srv::rosidl_typesupport_cpp::Distance_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, demo_interfaces_base, srv, Distance_Response)() {
  return get_message_type_support_handle<demo_interfaces_base::srv::Distance_Response>();
}
...
static const _Distance_type_support_symbol_names_t _Distance_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, demo_interfaces_base, srv, Distance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, demo_interfaces_base, srv, Distance)),
  }
};
...
get_service_type_support_handle<demo_interfaces_base::srv::Distance>()
{
  return &::demo_interfaces_base::srv::rosidl_typesupport_cpp::Distance_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, demo_interfaces_base, srv, Distance)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<demo_interfaces_base::srv::Distance>();
}
