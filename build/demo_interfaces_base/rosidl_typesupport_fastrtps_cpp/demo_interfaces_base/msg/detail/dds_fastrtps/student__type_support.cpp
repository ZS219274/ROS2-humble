...
#include "demo_interfaces_base/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = demo_interfaces_base::msg::Student;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const demo_interfaces_base::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<demo_interfaces_base::msg::Student *>(
    untyped_ros_message);
...
{
  return &demo_interfaces_base::msg::typesupport_fastrtps_cpp::_Student__handle;
}
