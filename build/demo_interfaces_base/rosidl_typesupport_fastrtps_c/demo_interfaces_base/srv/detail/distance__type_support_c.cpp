...
#include "demo_interfaces_base/srv/detail/distance__rosidl_typesupport_fastrtps_c.h"
...
using _Distance_Request__ros_msg_type = demo_interfaces_base__srv__Distance_Request;
...
size_t get_serialized_size_demo_interfaces_base__srv__Distance_Request(
  const void * untyped_ros_message,
...
static uint32_t _Distance_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_demo_interfaces_base__srv__Distance_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_demo_interfaces_base
size_t max_serialized_size_demo_interfaces_base__srv__Distance_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = demo_interfaces_base__srv__Distance_Request;
    is_plain =
      (
...
static size_t _Distance_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_demo_interfaces_base__srv__Distance_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, demo_interfaces_base, srv, Distance_Request)() {
...
using _Distance_Response__ros_msg_type = demo_interfaces_base__srv__Distance_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_demo_interfaces_base
size_t get_serialized_size_demo_interfaces_base__srv__Distance_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Distance_Response__ros_msg_type * ros_message = static_cast<const _Distance_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_demo_interfaces_base__srv__Distance_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_demo_interfaces_base
size_t max_serialized_size_demo_interfaces_base__srv__Distance_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = demo_interfaces_base__srv__Distance_Response;
    is_plain =
      (
...
static size_t _Distance_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_demo_interfaces_base__srv__Distance_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, demo_interfaces_base, srv, Distance_Response)() {
...
// already included above
// #include "demo_interfaces_base/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "demo_interfaces_base/srv/distance.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, demo_interfaces_base, srv, Distance)() {
