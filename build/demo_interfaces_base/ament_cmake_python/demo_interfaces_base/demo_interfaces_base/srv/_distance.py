...
class Metaclass_Distance(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'demo_interfaces_base.srv.Distance')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from demo_interfaces_base.srv import _distance
...
class Distance(metaclass=Metaclass_Distance):
    from demo_interfaces_base.srv._distance import Distance_Request as Request
    from demo_interfaces_base.srv._distance import Distance_Response as Response
