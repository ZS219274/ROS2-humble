...
{
  new (message_memory) demo_interfaces_base::msg::Student(_init);
}

void Student_fini_function(void * message_memory)
{
  auto typed_message = static_cast<demo_interfaces_base::msg::Student *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Student_message_member_array[3] = {
  {
    ...
    offsetof(demo_interfaces_base::msg::Student, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(demo_interfaces_base::msg::Student, age),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(demo_interfaces_base::msg::Student, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Student_message_members = {
  "demo_interfaces_base::msg",  // message namespace
  "Student",  // message name
  3,  // number of fields
  sizeof(demo_interfaces_base::msg::Student),
...
get_message_type_support_handle<demo_interfaces_base::msg::Student>()
{
  return &::demo_interfaces_base::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, demo_interfaces_base, msg, Student)() {
  return &::demo_interfaces_base::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
